                             ...
                             std::string discreteVolumeName, std::string outputVolumeName)
{
  ...
  LogisticRegression<PixelType> logisticRegressionWhiteVsGray = LogisticRegression<PixelType>(featureCount, grayMatterSampleCount+whiteMatterSampleCount);
  ...
  LogisticRegression<PixelType> logisticRegressionGrayVsCSF = LogisticRegression<PixelType>(featureCount, grayMatterSampleCount+csfSampleCount);
  ...
  LogisticRegression<PixelType> logisticRegressionVeinousBloodVsAll = LogisticRegression<PixelType>(featureCount, 
    veinousBloodSampleCount+whiteMatterSampleCount);
    ...
    if ( discretePixelValue == airDiscreteValue )
      ...
      if ( predictedProbabilityEstimatesWhiteVsGray[0] < predictedProbabilityEstimatesWhiteVsGray[1] )
        ...
        if ( predictedProbabilityEstimatesGrayVsCSF[0] < predictedProbabilityEstimatesGrayVsCSF[1] )
          ...
          if ( predictedProbabilityEstimatesVeinousBloodVsAll[0] > predictedProbabilityEstimatesVeinousBloodVsAll[1] )
            ...
            {
            // white vs gray
            predictedOutputPixelValue = static_cast<typename ImageType::PixelType>(130 + (120 * predictedProbabilityEstimatesWhiteVsGray[0])) ;
            }
          }
        }
      else
      ...
      if ( predictedProbabilityEstimatesGrayVsCSF[0] < predictedProbabilityEstimatesGrayVsCSF[1] )
        ...
        if ( predictedProbabilityEstimatesWhiteVsGray[0] > predictedProbabilityEstimatesWhiteVsGray[1] )
          ...
          {
          // CSF Vs Gray
          predictedOutputPixelValue = static_cast<typename ImageType::PixelType>(10 + 120*predictedProbabilityEstimatesGrayVsCSF[0]) ;
          }
        }
      else
        {
