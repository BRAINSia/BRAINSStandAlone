...
int main(int argc, char * argv [])
{
  ...
  std::cout << logisticRegressionModelWhiteVsCSF->label[0] << "," << logisticRegressionModelWhiteVsCSF->label[1] << std::endl;
  std::cout << logisticRegressionModelWhiteVsGray->label[0] << "," << logisticRegressionModelWhiteVsGray->label[1] << std::endl;
  std::cout << logisticRegressionModelGrayVsCSF->label[0] << "," << logisticRegressionModelGrayVsCSF->label[1] << std::endl;
