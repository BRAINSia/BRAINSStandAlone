...
/**
  ...
  * \return Void
  */
extern void ReadDisplacementField(TDisplacementField::Pointer & DisplacementField, const std::string & DisplacementFilename);
...
extern  void AddInputVector(std::vector<neural_scalar_type> & inputvector, itk::Image<itk::CovariantVector<float,
                            ...
                            const std::map<std::string,
                                           InternalImageType
                                           ::
                                           Pointer> & MapOfImages, const std::map<std::string,
                                                                                  InternalImageType
                                                                                  ::
                                                                                  Pointer> & MapOfDeformedROIs,
                            std::map<std::string,
                                     neural_scalar_type>
...
/**
  ...
  * \return Void
  */
extern void FillGradProfile(
  std::vector<float>::iterator & fi,
  const std::map<std::string, InternalImageType::Pointer>& MapOfImages, std::map<std::string,
                                                                                 ImageLinearInterpolatorType
                                                                                 ::
                                                                                 Pointer>
  MapOfImageInterpolators,
  //  const InternalImageType::Pointer DeformedProbMap,
  const InternalImageType::IndexType & CurrentIndex, const int ProfileExtent/*,
                           * const int IrisSize*/);
...
extern void LandmarkRegistraterImages(const std::string & InputImageFilename, const std::string & InputAtlasFilename,
                                      ...
                                      const std::string & ResultingImageFilename,
                                      const int MetaData);
