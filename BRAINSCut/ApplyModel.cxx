    ...
    BinaryMaskImageType::Pointer outputMask;
      ...
      ConnectedThresholdFilterType::Pointer ConnectedThresholdFilter =
        ConnectedThresholdFilterType::New();
        {
          ...
          {
          const BinaryMaskImageType::IndexType SeedLocation = { { ImageSize[0] - 1, ImageSize[1] - 1, ImageSize[2] - 1}};
          ConnectedThresholdFilter->SetSeed(SeedLocation);
          }
        }
               ...
               )
{
  ...
  RegistrationConfigurationParser *regParams = ANNConfiguration.Get<RegistrationConfigurationParser>("RegistrationConfigurationParser");
