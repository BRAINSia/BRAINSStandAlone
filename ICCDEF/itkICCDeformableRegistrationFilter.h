...
public:
  ...
  typedef VectorFFTWComplexConjugateToRealImageFilter<typename TDeformationField::PixelType, 3>  FFTWComplexToRealImageType;
  typedef VectorFFTWRealToComplexConjugateImageFilter<typename TDeformationField::PixelType, 3>  FFTWRealToComplexImageType;
...
protected:
  ...
  virtual
  void ThreadedComputeLinearElastic(DeformationFieldFFTPointer&, float normalizer, const ThreadRegionType &regionToProcess,
                                    int threadId);
