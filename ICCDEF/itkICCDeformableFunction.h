...
public:
  ...
  typedef VectorFFTWRealToComplexConjugateImageFilter<typename TDeformationField::PixelType, itkGetStaticConstMacro(ImageDimension)>  FFTWRealToComplexType;
  typedef VectorFFTWComplexConjugateToRealImageFilter<typename TDeformationField::PixelType, itkGetStaticConstMacro(ImageDimension)>  FFTWComplexToRealType;
...
//  typedef SubtractImageFilter<DeformationFieldType,  DeformationFieldType, DeformationFieldType> SubtractDeformationFieldType;
//  typedef SubtractImageFilter<DeformationFieldFFTType, DeformationFieldFFTType, DeformationFieldFFTType> SubtractDeformationFieldFFTType;
//  typedef MultiplyByConstantImageFilter<DeformationFieldType, float, DeformationFieldType> MultiplyByConstantImageType;
//  typedef MultiplyByConstantImageFilter<DeformationFieldFFTType, float, DeformationFieldFFTType> MultiplyByConstantFFTType;
