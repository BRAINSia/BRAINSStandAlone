...
MultiThreadIterativeInverseDeformationFieldImageFilter<TInputImage, TOutputImage>::MultiThreadIterativeInverseDeformationFieldImageFilter()
{
...
::ComputeInverse(InputImageConstPointer& inputPtr,OutputImagePointer& outputPtr, FieldInterpolatorPointer& inputFieldInterpolator, double spacing)
{
   ThreadStruct str;
   str.Filter = this;
...
::ComputeInverseThreaderCallback(void * arg)
{
  ...
  if (threadId < total)
    {
    str->Filter->ThreadedComputeInverse(str->inputPtr,str->outputPtr,str->interpolator, str->spacing, splitRegion, threadId);
    }
...
void 
MultiThreadIterativeInverseDeformationFieldImageFilter<TInputImage, TOutputImage>
::ThreadedComputeInverse(InputImageConstPointer& inputPtr, OutputImagePointer& outputPtr, FieldInterpolatorPointer& inputFieldInterpolator, double spacing, const ThreadRegionType &regionToProcess, int)
{
