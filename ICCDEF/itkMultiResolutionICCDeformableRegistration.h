...
public:
  ...
  /** Get number of iterations per multi-resolution levels. */
  itkGetObjectMacro(FieldExpander12, FieldExpanderType); //HACK: This should use the future implemented itkGetModifiableObjectMacro
  itkGetObjectMacro(FieldExpander21, FieldExpanderType); //HACK: This should use the future implemented itkGetModifiableObjectMacro
