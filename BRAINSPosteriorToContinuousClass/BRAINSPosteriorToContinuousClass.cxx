...
int main(int argc, char **argv)
{
  ...
  if (inputSurfaceGmVolume.size() == 0) { violated = true; std::cout << "  --inputSurfaceGmVolume Required! "  << std::endl; }
  if (inputCsfVolume.size() == 0) { violated = true; std::cout << "  --inputCsfVolume Required! "  << std::endl; }
  if (inputVbVolume.size() == 0) { violated = true; std::cout << "  --inputVbVolume Required! "  << std::endl; }
  if (inputCrblGmVolume.size() == 0) { violated = true; std::cout << "  --inputCrblGmVolume Required! "  << std::endl; }
