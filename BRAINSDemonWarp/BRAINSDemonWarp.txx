...
::InitializeRegistrator()
{
  ...
  this->m_Registrator->SetUnNormalizedFixedImage( this->m_Preprocessor->GetUnNormalizedFixedImage() );
       ...
       itkUtil::WriteImage<TRealImage>(this->m_Preprocessor->GetOutputFixedImage(), "m_Preprocessor_GetOutputFixedImage.nii.gz");
       itkUtil::WriteImage<TRealImage>(this->m_Preprocessor->GetOutputMovingImage(), "m_Preprocessor_GetOutputMovingImage.nii.gz");
       itkUtil::WriteImage<TRealImage>(this->m_Preprocessor->GetUnNormalizedFixedImage(), "m_Preprocessor_GetUnNormalizedFixedImage.nii.gz");
       itkUtil::WriteImage<TRealImage>(this->m_Preprocessor->GetUnNormalizedMovingImage(), "m_Preprocessor_GetUnNormalizedMovingImage.nii.gz");
#endif
