...
int main( int argc, char *argv[] )
{
  ...
  if ( scalarArray )
  {
	  ...
	  for (int array_i = 0; array_i < numArrays; array_i++)
	  {
		  ...
		  { 
			  std::cout<<"The number of tuples at "<<array_i<<"th array are different between two surfaces."<<std::endl;
              std::cout<<"Test failed."<<std::endl;
			  return EXIT_FAILURE;
		  }
		  ...
		  {
			  std::cout<<"The number of components at "<<array_i<<"th array are different between two surfaces."<<std::endl;
              std::cout<<"Test failed."<<std::endl;
			  return EXIT_FAILURE;
		  }
