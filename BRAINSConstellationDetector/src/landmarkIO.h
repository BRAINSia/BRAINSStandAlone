...
extern void MakeBrandeddebugImage(SImageType::ConstPointer in, 
...
extern void MakePointBranded3DImage(SImageType::ConstPointer in, 
                                    const SImageType::PointType & CenterPoint,
                                    const std::string & fname);

extern void MakeBranded2DImage(SImageType::ConstPointer in, 
...
extern void WriteMRMLFile(std::string outputMRML, 
...
// .load from txt file
extern void loadLLSModel(std::string llsModel,
...
extern void writeLLSModel(const std::string & modelName,
                          ...
                          const std::map<std::string, MatrixType> & llsMatrices, 
                          const std::map<std::string, double> & searchRadii);

extern void readLLSModel(const std::string & modelName,
                         std::map<std::string, std::vector<double> > & llsMeans,
                         std::map<std::string, MatrixType> & llsMatrices, 
                         std::map<std::string, double> & searchRadii);

// write out verification script
extern void writeVerificationScript(std::string outputVerificationScript, 
                                    std::string outputVolume,
