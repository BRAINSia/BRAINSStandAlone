...
// This program gets a row of the fcsv files. The first argument is the number of pair landmark files for example (e0326_10335.fcsv , k0326_10335.fcsv) 
...
// *** FOR EACH PAIR FILES: ****
// We have two fcsv file for each volume case (e.g. we have 20 cases, and there are two landmark files (.fcsv) correspondence to each case).
// Each fcsv file contains several landmarks (e.g. 30 landmarks as AC, PC, ...)
// Therefore, for each landmark point in each case, we have two correspondent coordinate in the two correspondent fcsv files.
...
int main( unsigned int argc, char * argv[] )
{
	...
	// LandmarksMapType is as "std::map<std::string, PointType>" which means a map between landmarks and their coordinates.
