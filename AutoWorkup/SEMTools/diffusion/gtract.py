...
class gtractCreateGuideFiber(SlicerCommandLine):
...
class compareTractInclusion(SlicerCommandLine):
...
class gtractFastMarchingTracking(SlicerCommandLine):
...
class gtractFiberTracking(SlicerCommandLine):
...
class gtractResampleFibers(SlicerCommandLine):
