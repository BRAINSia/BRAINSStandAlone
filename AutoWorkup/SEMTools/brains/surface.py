...
class IcosahedronResampler(SlicerCommandLine):
    """title: 
...
class QuadEdgeMeshClampScalars(SlicerCommandLine):
    """title: 
...
class BRAINSApplySurfaceLabels(SlicerCommandLine):
    """title: 
...
class BRAINSSurfaceGeneration(SlicerCommandLine):
    """title: 
...
class LabelMaps(SlicerCommandLine):
    """title: 
    BRAINS Label Maps
...
class QuadEdgeMeshHistogramMatching(SlicerCommandLine):
    """title: 
...
class ResampleQuadEdgeMesh(SlicerCommandLine):
    """title: 
...
class QuadEdgeMeshPiecewiseRescale(SlicerCommandLine):
    """title: 
...
class AssignArray(SlicerCommandLine):
    """title: 
    BRAINS Assign Array
...
class SurfaceColor(SlicerCommandLine):
    """title: 
...
class BRAINSMeasureSurface(SlicerCommandLine):
    """title: 
...
class SurfaceLabelCleanUp(SlicerCommandLine):
    """title: 
...
class MultiResolutionRegistration(SlicerCommandLine):
    """title: 
...
class BRAINSAssignSurfaceFeatures(SlicerCommandLine):
    """title: 
...
class ProbabilityLabels(SlicerCommandLine):
    """title: 
...
class RemoveTinyLabels(SlicerCommandLine):
    """title: 
...
class AverageScalarsByResampling(SlicerCommandLine):
    """title: 
...
class WarpQuadEdgeMesh(SlicerCommandLine):
    """title: 
...
class RearrangeSurfaceLabels(SlicerCommandLine):
    """title: 
...
class BRAINSSurfaceFlattening(SlicerCommandLine):
    """title: 
...
class SmoothingMeshScalarsInputSpec(CommandLineInputSpec):
    inputSurfaceFile = File(desc="Input Surface Filename", exists=True, argstr="--inputSurfaceFile %s")
    xxlambda = traits.Float(desc="The value to control the smoothing effect.", argstr="--lambda %f")
...
class SmoothingMeshScalars(SlicerCommandLine):
    """title: 
...
class QuadEdgeMeshSimilarity(SlicerCommandLine):
    """title: 
...
class CombineLabels(SlicerCommandLine):
    """title: 
