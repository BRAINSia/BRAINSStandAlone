...
class CannySegmentationLevelSetImageFilter(SlicerCommandLine):
...
class DilateImage(SlicerCommandLine):
    """title: Dilate Image
...
class TextureFromNoiseImageFilter(SlicerCommandLine):
...
class FlippedDifference(SlicerCommandLine):
    """title: Flip Image
...
class CannyEdge(SlicerCommandLine):
...
class ErodeImage(SlicerCommandLine):
    """title: Erode Image
...
class GenerateBrainClippedImage(SlicerCommandLine):
...
class NeighborhoodMedian(SlicerCommandLine):
...
class GenerateTestImage(SlicerCommandLine):
...
class NeighborhoodMean(SlicerCommandLine):
...
class DistanceMaps(SlicerCommandLine):
...
class TextureMeasureFilter(SlicerCommandLine):
    """title:  Canny Level Set Image Filter 
...
class DilateMask(SlicerCommandLine):
    """title: Dilate Image
...
class HammerAttributeCreator(SlicerCommandLine):
...
class STAPLEAnalysis(SlicerCommandLine):
    """title: Dilate Image
...
class NoiseGenerator(SlicerCommandLine):
    """title: Add Noise
