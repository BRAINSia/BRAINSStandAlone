...
class BuildTemplateParallel():

    def BuildTemplateParallel(self):

        ExperimentBaseDirectoryCache = '/scratch/antsbuildtemplate/TEST_CACHE3'
