...
test.inputs.transformation_model = ['SyN', 'Affine']
test.inputs.transformation_gradient_step_length = [0.25, 0.25]
test.inputs.transformation_number_of_time_steps = [3.0]
test.inputs.transformation_delta_time = [0.0]
test.inputs.number_of_iterations = [100,70,20]
