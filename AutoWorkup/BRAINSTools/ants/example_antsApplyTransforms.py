...
test.inputs.invert_transforms_list = [0]


#result = test.run()
#print result.outputs

target = "/ipldev/scratch/johnsonhj/src/ANTS-Darwin-clang/bin/antsApplyTransforms --default-value 0 --dimensionality 3 --input /hjohnson/HDNI/EXPERIEMENTS/ANTS_NIPYPE_SMALL_TEST/SUBJ_B_T1_resampled.nii.gz"
...
target += " --transform [/hjohnson/HDNI/EXPERIEMENTS/ANTS_NIPYPE_SMALL_TEST/20120430_1348_ANTS6_1Warp.nii.gz,0] --transform [/hjohnson/HDNI/EXPERIEMENTS/ANTS_NIPYPE_SMALL_TEST/20120430_1348_txfmv2fv_affine.mat,0]"
